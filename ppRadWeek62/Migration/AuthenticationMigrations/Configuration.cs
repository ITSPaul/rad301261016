namespace ppRadWeek62.Migration.AuthenticationMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ppRadWeek62.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ppRadWeek62.Models.ApplicationDbContext context)
        {
            var manager =
